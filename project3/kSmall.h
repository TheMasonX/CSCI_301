 ...
 * @param anArray Pointer to the input array to be partitioned.
 ...
 * @param anArray Pointer to the input array from which to find the k-th smallest element.
...
int kSmall(int k, int* anArray, int size) {
    return kSmall(k, anArray, 0, size - 1);
}
